...
valueType Node::getData() const { return dataField; }
...
Node *Node::getLink() const { return linkPtr; }

Node *Node::getLink() { return linkPtr; }
...
void Node::setData(const valueType &newData) { dataField = newData; }
...
void Node::setLink(Node *newLinkPtr) { linkPtr = newLinkPtr; }
